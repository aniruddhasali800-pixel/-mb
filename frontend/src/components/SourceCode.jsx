            ...
            <div className="dashboard-container" style={{ marginTop: '0' }}>
                {loading ? (
                    ...
                    >
                        ...
                        <div style={{ display: 'flex', gap: '15px' }}>
                            <div className="hub-action" style={{ color: '#0ea5e9' }} onClick={() => {
                                axios.put(`${API_BASE_URL}/api/admin/content/${project._id}/view`).catch(err => console.error(err));
                                window.open(`${API_BASE_URL}${project.fileUrl}`, '_blank');
                            }}>
                                <Eye size={16} /> View
                            </div>
